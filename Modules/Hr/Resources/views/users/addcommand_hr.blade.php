...
@section('content')
	<section class="content-header">
		...
		<section class="content">
			<div class="container-fluid">
				<form method="post" action="{{ route('users.insert_command_hr', [$id]) }}">
					@csrf
					<div class="row">
						<div class="col-12">
							<div class="card">
											...
											<div class="form-group">
												<div id="Command">
													<label for="comm_num">เลขคำสั่งแต่งตั้งที่ 1 </label>
					                                    {{-- <input type="text" class="form-control" name="comm_num[]" id="comm_num" autocomplete="off" required> --}}
					                                    ...
					                                    <div class="input-group date" id="datepicker2">
					                                        <input class=" form-control input-medium" name="comm_date[]" type="text" data-provide="datepicker" data-date-language="th" data-date-format="yyyy-mm-dd" placeholder="ปี/เดือน/วัน" autocomplete="off" id="comm_date" required="">
