...
<!-- Datepicker Thai -->
<link rel="stylesheet" href="<?php echo e(asset('bower_components/datepicker-thai/css/datepicker.css')); ?>">
<!-- Select2 -->
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('bower_components/bootstrap-select/bootstrap-select.min.css')); ?>">
<!-- Select2.org-->
<link rel="stylesheet" href="<?php echo e(asset('bower_components/select2_custom/dist/css/select2.min.css')); ?>">
<?php $__env->stopSection(); ?>
    ...
    <div class="container">
        <div class ="text-center">
            <a class="navbar-brand" href="#">
                <img src="<?php echo e(asset('img/Logo_ddc.png')); ?>" width="130"  alt="Logo_ddc.png">
            </a><br>
        ...
        <div class ="text-right">
            <a href="<?php echo e(route('login.ecosystem')); ?>" type="button" class="btn btn-info"><i class="fa fa-home"></i> กลับหน้าหลัก</a>
        </div><br>
        <!-- end ปุ่ม home ย้อนกลับ -->

        <form method="POST" action="<?php echo e(route('register.insert')); ?>" class="was-validated">
            <?php echo csrf_field(); ?>
            <!-- ส่วนที่ 1 User-->
            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" name="prefix_th" required>
                                            ...
                                            <?php $__currentLoopData = $ref_prefix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->id); ?>"><?php echo e($value->name_th); ?> </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" id="organization_type" name="organization_type" required>
                                            ...
                                            <?php $__currentLoopData = $organization_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_division_part => $value_division_part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key_division_part); ?>"><?php echo e($value_division_part); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="position" class="form-control custom-select"  name="position" data-live-search="true" required>
                                            <option value="">กรุณาเลือก</option>
                                            <?php $__currentLoopData = $posit_ref; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value_posit_ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value_posit_ref->position_id); ?>"><?php echo e($value_posit_ref->position_name); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="job_level" class="form-control custom-select"  name="job_level" data-live-search="true" required>
                                            <option value="">กรุณาเลือก</option>
                                            <?php $__currentLoopData = $job_level; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val_job_level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($val_job_level->id); ?>"><?php echo e($val_job_level->job_level_name); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="emp_level" class="form-control custom-select"  name="emp_level" data-live-search="true" required>
                                            <option value="">กรุณาเลือก</option>
                                            <?php $__currentLoopData = $emp_level; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_emp_level => $val_emp_level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key_emp_level); ?>"><?php echo e($val_emp_level); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" name="talent_lang_eng">
                                            ...
                                            <?php $__currentLoopData = $talent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->id); ?>"><?php echo e($value->id); ?>.<?php echo e($value->talent_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <select class="form-control custom-select" name="talent_drive">
                                        <option value="" selected>กรุณาเลือก</option>
                                        <?php $__currentLoopData = $talent_drive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value->id); ?>"><?php echo e($value->id); ?>.<?php echo e($value->drive); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-sm-6 form-group">
                                    ...
                                    <select class="form-control custom-select" name="talent_course">
                                        <option value="" selected>กรุณาเลือก</option>
                                        <?php $__currentLoopData = $talent_course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value->course_id); ?>"><?php echo e($value->course); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-sm-6 form-group">
...
<!-- datepicker -->
<script src="<?php echo e(asset('bower_components/datepicker-thai/js/bootstrap-datepicker.js')); ?>"></script>
<script src="<?php echo e(asset('bower_components/datepicker-thai/js/bootstrap-datepicker-thai.js')); ?>"></script>
<script src="<?php echo e(asset('bower_components/datepicker-thai/js/locales/bootstrap-datepicker.th.js')); ?>"></script>
<!-- Select2 -->
<script src="<?php echo e(asset('bower_components/bootstrap-select/bootstrap-select.min.js')); ?>"></script>
<!-- SweetAlert2 -->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
<!-- Select2.org -->
<script src="<?php echo e(asset('bower_components/select2_custom/dist/js/select2.min.js')); ?>"></script>
<script>
    ...
    $(document).ready(function() {
      ...
      <?php if($message = Session::get('success')): ?>
          Swal.fire({
              ...
              if (result.value) {
                  window.location = "<?php echo e(env('APP_URL')); ?>";
              }
          })
      <?php endif; ?>
        //หน่วยงาน
        ...
        $('#organization_type').change(function() {
      		...
      		if (organization_type > 0) {
      			...
      			$.ajax({
      				method: "GET",
      				url: "<?php echo e(route('ajax.get_list_agency')); ?>",
      				dataType: 'html',
        ...
        $('#organization').change(function() {
      		...
      		if (organization_id > 0) {
      			...
      			$.ajax({
      				method: "GET",
      				url: "<?php echo e(route('ajax.get_role_group_by')); ?>",
      				dataType: 'html',
        ...
        $("#username").focusout(function(){
            ...
            if ($(this).val().match(SpacialCharacter)) {
                ...
                $.ajax({
                    type: "GET",
                    url : "<?php echo e(route('register.checkRepeat')); ?>",
...
<?php echo $__env->make('member::layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Modules/Member/Resources/views/frontend/register.blade.php ENDPATH**/ ?>